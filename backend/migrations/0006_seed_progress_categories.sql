...
INSERT OR IGNORE INTO progress_categories (
    ...
    ('SYSTEMS_SECURITY', 'Network & Security', 'Systems, networks, infrastructure, and security.', 12, 'cat-tech', 40),
    ('DATA_DATABASES', 'Data Science', 'Database systems, data engineering, and data-intensive computing.', 12, 'cat-info', 50),
    ...
    ('HCI_UX', 'UI & UX', 'Interaction techniques, HCI, and usability.', 12, 'cat-info', 80),
